...
void glVertex2f(float x, float y) { glVertex4f(x, y, 0, 1); }

void glVertex3f(float x, float y, float z) { glVertex4f(x, y, z, 1); }

void glVertex3fv(float *v) { glVertex4f(v[0], v[1], v[2], 1); }
...
void glNormal3fv(float *v) { glNormal3f(v[0], v[1], v[2]); }
...
void glColor4f(float r, float g, float b, float a) {
  ...
  p[5].ui =
      (uint32_t)(r * (ZB_POINT_RED_MAX - ZB_POINT_RED_MIN) + ZB_POINT_RED_MIN);
...
void glColor3f(float x, float y, float z) { glColor4f(x, y, z, 1); }

void glColor3fv(float *v) { glColor4f(v[0], v[1], v[2], 1); }
...
void glTexCoord2f(float s, float t) { glTexCoord4f(s, t, 0, 1); }

void glTexCoord2fv(float *v) { glTexCoord4f(v[0], v[1], 0, 1); }
...
void glTexImage2D(int target, int level, int components, int width, int height,
